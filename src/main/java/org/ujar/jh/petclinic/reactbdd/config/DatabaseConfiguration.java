...
@Configuration
@EnableR2dbcRepositories({ "org.ujar.jh.petclinic.reactbdd.repository" })
@EnableTransactionManagement
@EnableReactiveElasticsearchRepositories("org.ujar.jh.petclinic.reactbdd.repository.search")
