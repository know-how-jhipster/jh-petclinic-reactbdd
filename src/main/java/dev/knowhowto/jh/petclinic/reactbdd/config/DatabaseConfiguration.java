...
@Configuration
@EnableR2dbcRepositories({ "dev.knowhowto.jh.petclinic.reactbdd.repository" })
@EnableTransactionManagement
@EnableReactiveElasticsearchRepositories("dev.knowhowto.jh.petclinic.reactbdd.repository.search")
