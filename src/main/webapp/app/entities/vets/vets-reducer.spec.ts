...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VETS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_VETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_VETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VETS actions', async () => {
      const expectedActions = [
        {
