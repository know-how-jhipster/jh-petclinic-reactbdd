...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VISITS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_VISITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_VISITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VISITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VISITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VISITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VISITS actions', async () => {
      const expectedActions = [
        {
