...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PETS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PETS actions', async () => {
      const expectedActions = [
        {
