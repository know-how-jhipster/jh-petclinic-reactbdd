...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OWNERS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_OWNERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_OWNERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OWNERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OWNERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OWNERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OWNERS actions', async () => {
      const expectedActions = [
        {
