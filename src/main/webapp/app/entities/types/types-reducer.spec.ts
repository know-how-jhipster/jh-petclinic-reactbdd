...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TYPES actions', async () => {
      const expectedActions = [
        {
