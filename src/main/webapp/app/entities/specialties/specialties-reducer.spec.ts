...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIALTIES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SPECIALTIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SPECIALTIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPECIALTIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPECIALTIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPECIALTIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPECIALTIES actions', async () => {
      const expectedActions = [
        {
